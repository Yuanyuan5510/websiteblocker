...
OutputBaseFilename=网站访问限制工具安装程序v1.9
Compression=lzma2
...
UninstallDisplayName=网站访问限制工具 v1.9
; 从主程序提取图标
...
[Icons]
Name: "{group}\网站访问限制工具 v1.9"; Filename: "{app}\网站访问限制工具.exe"
Name: "{group}\网站限制配置管理器"; Filename: "{app}\限制网站访问限制配置管理器.exe"
Name: "{group}\卸载网站访问限制工具 v1.9"; Filename: "{uninstallexe}"
Name: "{commondesktop}\网站访问限制工具 v1.9"; Filename: "{app}\网站访问限制工具.exe"; Tasks: desktopicon
...
[Messages]
chinese.WelcomeLabel2=欢迎使用网站访问限制工具 v1.9 安装向导。
chinese.FinishedHeadingLabel=网站访问限制工具 v1.9 安装完成