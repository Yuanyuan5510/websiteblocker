...
[Files]
; 主程序文件
Source: "dist\WebsiteBlocker_Setup_3.9.exe"; DestDir: "{app}"; Flags: ignoreversion

; 图标文件
Source: "dist\app_icon.ico"; DestDir: "{app}"; Flags: ignoreversion

; 配置文件
Source: "dist\website_blocker_config.json"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
; 桌面快捷方式
Name: "{autodesktop}\{#AppName}"; Filename: "{app}\WebsiteBlocker_Setup_3.9.exe"; WorkingDir: "{app}"; IconFilename: "{app}\app_icon.ico"; Comment: "网站访问限制工具"

; 开始菜单快捷方式
Name: "{group}\{#AppName}"; Filename: "{app}\WebsiteBlocker_Setup_3.9.exe"; WorkingDir: "{app}"; IconFilename: "{app}\app_icon.ico"; Comment: "网站访问限制工具"
...
[Run]
; 安装完成后运行程序
Filename: "{app}\WebsiteBlocker_Setup_3.9.exe"; Description: "运行网站访问限制工具"; Flags: nowait postinstall skipifsilent
...
[UninstallRun]
; 卸载前关闭正在运行的程序
Filename: "taskkill.exe"; Parameters: "/f /im WebsiteBlocker_Setup_3.9.exe"; Flags: runhidden
